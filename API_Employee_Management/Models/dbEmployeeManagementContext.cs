    ...
    public partial class dbEmployeeManagementContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=LAPTOP-EBOA1BLK;Initial Catalog=dbEmployeeManagement;Integrated Security=True");
                optionsBuilder.UseSqlServer("Name=Employee_ManagementContext");
            }
        }
